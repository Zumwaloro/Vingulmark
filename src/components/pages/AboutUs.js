      ...
      return (
        <div>
          ...
          <div id="textDiv">
            ...
            <TextElement text={input3} id="text-third" />
            <ImgHolder img={about3} imgId="about3" frame="frame3"/>
            <ImgHolder img={about4} imgId="about4" frame="frame4"/>
            <TextElement text={input4} id="text-fourth" />
          </div>
        </div>
      );
    }
